...
public class ClosestBeachesButtonTest {
    @Rule
    ...
    {
        onView(withId(R.id.option_get_place)).perform(ViewActions.click());
        onView(withText("Closest 5 Beaches")).check(matches(isDisplayed()));
    }
}
